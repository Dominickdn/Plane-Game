window.onload = function() {
  ...
  soundOn.src="assets/sound on.png"

  let soundOff=new Image();
  soundOff.src="assets/sound off.png"
  
  //Background image
  let background = new Image();                      
  background.src = "assets/Background plane game.jpg";
  //plane image
  let plane = new Image();
  plane.src= "assets/Plane model game.png"; 
  //missile
...
// EVENT LISTENERS /////////////////////////////////
  ...
  document.addEventListener('keydown', function(event) {
    if (event.code === 'Space') {
      event.preventDefault(); //default event scrolls down
...
coinSound.src="assets/zapsplat_foley_money_british_coin_20p_set_down_on_other_coins_in_hand_change_001_90492.mp3";

let planeSound1=new Audio();
planeSound1.src="assets/smartsound_TRANSPORTATION_ULTRALIGHT_PLANE_Fly_Slow_Steady_Loop_01.mp3";

let radioSound=new Audio();
radioSound.src="assets/zapsplat_vehicles_airplane_atc_comm_pilot_radio_indistinguishable_006_39882.mp3";

let gameOverSound= new Audio();
gameOverSound.src="assets/mixkit-negative-guitar-tone-2324.wav";

let soundTrack = new Audio();
soundTrack.src="assets/crash-override-classic-arcade-game-116842.mp3"
...
//Game Loop
  ...
  function startScreen(){
    ...
    startbtn.src="assets/Start Button.png";
    context.clearRect(0, 0, 1300, 600);
    context.drawImage(background,x,0,1305,500);
    context.drawImage(background,x1,0,1305,500);
    context.drawImage(background,x2,0,1305,500);
